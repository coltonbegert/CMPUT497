...
char wifi_name[] = "Wifi-RSSI test";
char wifi_password[] = "testtest";
...
void setup()
{
    ...
    Serial.println("*** LaunchPad CC3200 WiFi Web-Server in AP Mode without sd card ");
